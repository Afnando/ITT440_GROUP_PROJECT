...
def process_start(s_sock):
  ...
  while True:
    ...
    if str(opt.decode('ascii')) in d.keys():
      ...
      if ans == "YES":  #if client want to delete
        ...
        if bool(res) == True:
          ...
          if ans2 == "YES":# if client want to delete a list of product and start procee delete based on product name
            ...
            global tott1
            tott=0
            for i in range(len(n)):  #total product after delete
        ...
        print("Client Dont delete anything..") # if client dont want to delete
        sum2=0
